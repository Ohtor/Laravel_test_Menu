            ...
            <div class="col-lg-4 mx-auto">
                <main class="form-signin w-100 m-auto" >
                    <form action="{{route('recipes.store')}}" method="post" >
                        ...
                        <h1 class="h3 mb-3 fw-normal">Adding recipe:</h1>
                  
                        <div class="form-floating mt-2 mb-2" >
                            <input type="text" name="recipe" class="form-control" id="recipe" required placeholder="What recipe?">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-8 mt-2 mb-2">
                                    <input type="text" name="components[{{ $i }}][key]" class="form-control" value="{{ old('components['.$i.'][key]') }}">
                                </div>
                                <div class="col-md-4 mt-2 mb-2">
                                    <input type="number" name="components[{{ $i }}][value]" class="form-control" value="{{ old('components['.$i.'][value]') }}">
                                </div>
                            </div>
                            @endfor
                        </div>
